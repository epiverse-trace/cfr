...
```
Hence in this particular simulation, the `cfr_static()` method recovers the correct CFR of 10%, whereas the filtering method produces a biased estimate of 26%.
