...
This vignette demonstrates how to calculate a static estimate of the severity of an outbreak using methods outlined @nishiura2009, and implemented in _cfr_.
