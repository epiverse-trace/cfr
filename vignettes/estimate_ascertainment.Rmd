...
This vignette outlines the function within _cfr_ used to estimate the
...
The function `estimate_reporting()` from the _cfr_ package estimates the 
...
We outline how the time-varying severity estimation works in *cfr* using 
...
We use the `estimate_reporting()` function within the _cfr_ package to 
