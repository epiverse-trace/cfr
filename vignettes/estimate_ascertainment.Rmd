...
This vignette outlines the function within _datadelay_ used to estimate the
...
The function `estimate_reporting()` from the _datadelay_ package estimates the 
...
We use the `estimate_reporting()` function within the _datadelay_ package to 
