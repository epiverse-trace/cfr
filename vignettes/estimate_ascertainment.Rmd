...
See the [vignette on static severity estimation](estimate_static_severity.html) to learn more about how `estimate_static()` choses a method for profile likelihood generation and hence CFR estimation.
