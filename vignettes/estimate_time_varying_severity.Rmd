...
This vignette outlines how to use _datadelay_ to estimate how the severity of a
...
using the _datadelay_ package includes:
...
The function `estimate_time_varying()` from the _datadelay_ package estimates
...
We use the `estimate_time_varying()` function within the _datadelay_ package 
