...
The `cfr_time_varying()` function requires a `data.frame` of input data --- typically case and death time series data --- and optionally, a delay distribution density function to allow for delay correction.
