...
plot_time_varying(df_covid_cfr_uk_naive, lower = 0, upper = 100)
```
...
plot_time_varying(df_covid_cfr_uk_corrected, lower = 0, upper = 100)
```
...
subset(df_covid_cfr, country == "Brazil") |>
  plot_time_varying(lower = 0, upper = 10)
```
