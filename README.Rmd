...
This example shows how to use _{{ packagename }}_ to estimate the overall case fatality risks from the 1976 Ebola outbreak [@camacho2014].
...
cfr_static(data = ebola1976, correct_for_delays = FALSE)
