...
_{{ packagename }}_ is an R package that provides simple, fast methods based on @nishiura2009 to estimate disease severity and under-reporting in real-time, accounting for delays in epidemic time-series.
