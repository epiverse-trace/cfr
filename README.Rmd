...
The `cfr_rolling()` function uses the `cfr_severity()` adjustment to account for delays, and instead compares deaths-to-date with cases-with-known-outcome-to-date.
