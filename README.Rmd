...
In this example we show how the severity estimate can change as more data on the outbreak becomes available, using the function `estimate_rolling()`.

This example shows how the rolling estimate converges to the overall static estimate towards the end of the outbreak.
