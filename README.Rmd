...
_{{ packagename }}_ is an R package that provides simple, fast methods, based in part on @nishiura2009, to estimate disease severity and under-reporting in real-time, accounting for delays in epidemic time-series.
...
This example of basic usage shows how to use _{{ packagename }}_ to estimate case fatality ratios from the 1976 Ebola outbreak.
